...
function onSignInStatusChanged(isSignedIn) {
    ...
    if (isAuthorized) {
        ...
        googlePicker = new GoogleDriveAPI_1.GoogleDriveAPI('AIzaSyB6Jfd-o3v5RafVjTNnkBevhjX3_EHqAlE', user.getAuthResponse().access_token);
    }
    else {
...
window.handleClientLoad = () => {
    ...
    googleAuth = new GoogleAuthAPI_1.GoogleAuthAPI('AIzaSyB6Jfd-o3v5RafVjTNnkBevhjX3_EHqAlE', '658362738764-9kdasvdsndig5tsp38u7ra31fu0e7l5t.apps.googleusercontent.com', SCOPE, ['https://www.googleapis.com/discovery/v1/apis/drive/v3/rest'], onLoaded, onSignInStatusChanged);
